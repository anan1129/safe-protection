...
@Form.create()
export default class RadioQuestionsTable extends PureComponent {
  state = {
  ...
  getQuestions(params) {
    ...
    dispatch({
      type: 'question/getRadioQuestions',
      payload:{
  ...
  delQuestion(record) {
    const {dispatch} =this.props;
    dispatch({
      type:'question/delRadioQuestion',
      payload:record.id,
    }).then(()=>{
      this.setState({
        pagination:{
    ...
    form.validateFields((err,values)=>{
      if(!err){
        ...
        if(JSON.stringify(modalQuestion)=='{}'){
          dispatch({
            type:'question/postRadioQuestions',
            payload:data,
          }).then(()=>{
            this.initModal();
            this.getQuestions();
          ...
          dispatch({
            type:'question/putRadioQuestions',
            payload:data,
          }).then(()=>{
            this.initModal();
            this.getQuestions();
  ...
  initModal(){
    ...
    this.refs.dynamicAddRadio.initForm();
  }
